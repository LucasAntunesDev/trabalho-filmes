...
@endforeach
@else
<section class="bg-red-500 w-screen grid grid-cols-1 md:grid-cols-4 justify-items-center h-fit" data-modal-target="default-modal" data-modal-toggle="default-modal">
    @foreach ($filmes as $filme)
